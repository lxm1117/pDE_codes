...
extern int nrn_get_mechtype();
 ...
 "setdata_KDRc_i1", _hoc_setdata,
 "Boltz_m1_KDRc_i1", _hoc_Boltz_m1,
 "BorgMod_tau_KDRc_i1", _hoc_BorgMod_tau,
 "Boltzmann_KDRc_i1", _hoc_Boltzmann,
 "ngate_adjust_KDRc_i1", _hoc_ngate_adjust,
 "rates_KDRc_i1", _hoc_rates,
 0, 0
};
#define Boltz_m1 Boltz_m1_KDRc_i1
#define BorgMod_tau BorgMod_tau_KDRc_i1
#define Boltzmann Boltzmann_KDRc_i1
 extern double Boltz_m1();
 extern double BorgMod_tau();
 extern double Boltzmann();
 /* declare global and static user variables */
#define gates_n gates_n_KDRc_i1
 double gates_n = 1;
#define inf_n inf_n_KDRc_i1
 double inf_n = 0;
#define needAdj needAdj_KDRc_i1
 double needAdj = 1;
#define slp_adj slp_adj_KDRc_i1
 double slp_adj = 0;
#define slopeA_n slopeA_n_KDRc_i1
 double slopeA_n = 0;
#define slope_n slope_n_KDRc_i1
 double slope_n = -10;
#define tau0_n tau0_n_KDRc_i1
 double tau0_n = 0.8;
#define tauF_n tauF_n_KDRc_i1
 double tauF_n = 0;
#define tauG_n tauG_n_KDRc_i1
 double tauG_n = 0.8;
#define tauDv_n tauDv_n_KDRc_i1
 double tauDv_n = 0;
#define tauA_n tauA_n_KDRc_i1
 double tauA_n = 5.9;
#define tau_n tau_n_KDRc_i1
 double tau_n = 0;
#define v5_adj v5_adj_KDRc_i1
 double v5_adj = 0;
#define vhalfA_n vhalfA_n_KDRc_i1
 double vhalfA_n = 0;
#define vhalf_n vhalf_n_KDRc_i1
 double vhalf_n = -5;
 ...
 "gates_n_KDRc_i1", &gates_n_KDRc_i1,
 "vhalf_n_KDRc_i1", &vhalf_n_KDRc_i1,
 "slope_n_KDRc_i1", &slope_n_KDRc_i1,
 "needAdj_KDRc_i1", &needAdj_KDRc_i1,
 "vhalfA_n_KDRc_i1", &vhalfA_n_KDRc_i1,
 "slopeA_n_KDRc_i1", &slopeA_n_KDRc_i1,
 "v5_adj_KDRc_i1", &v5_adj_KDRc_i1,
 "slp_adj_KDRc_i1", &slp_adj_KDRc_i1,
 "tauA_n_KDRc_i1", &tauA_n_KDRc_i1,
 "tauDv_n_KDRc_i1", &tauDv_n_KDRc_i1,
 "tauG_n_KDRc_i1", &tauG_n_KDRc_i1,
 "tauF_n_KDRc_i1", &tauF_n_KDRc_i1,
 "tau0_n_KDRc_i1", &tau0_n_KDRc_i1,
 "inf_n_KDRc_i1", &inf_n_KDRc_i1,
 "tau_n_KDRc_i1", &tau_n_KDRc_i1,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 KDRc_i1 /home/ximing/Documents/lab_stuff/pDE_cell/i686/KDRc_i1.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 49 in file KDRc_i1.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
