...
extern int nrn_get_mechtype();
 ...
 "setdata_KA_i1", _hoc_setdata,
 "Boltz_m1_KA_i1", _hoc_Boltz_m1,
 "BorgMod_tau_KA_i1", _hoc_BorgMod_tau,
 "Boltzmann_KA_i1", _hoc_Boltzmann,
 "ngate_adjust_KA_i1", _hoc_ngate_adjust,
 "rates_KA_i1", _hoc_rates,
 0, 0
};
#define Boltz_m1 Boltz_m1_KA_i1
#define BorgMod_tau BorgMod_tau_KA_i1
#define Boltzmann Boltzmann_KA_i1
 extern double Boltz_m1();
 extern double BorgMod_tau();
 extern double Boltzmann();
 /* declare global and static user variables */
#define gates_h gates_h_KA_i1
 double gates_h = 1;
#define gates_n gates_n_KA_i1
 double gates_n = 4;
#define inf_h inf_h_KA_i1
 double inf_h = 0;
#define inf_n inf_n_KA_i1
 double inf_n = 0;
#define needAdj needAdj_KA_i1
 double needAdj = 1;
#define slope_h slope_h_KA_i1
 double slope_h = 8;
#define slp_adj slp_adj_KA_i1
 double slp_adj = 0;
#define slopeA_n slopeA_n_KA_i1
 double slopeA_n = 0;
#define slope_n slope_n_KA_i1
 double slope_n = -18;
#define tau0_h tau0_h_KA_i1
 double tau0_h = 0.01;
#define tauF_h tauF_h_KA_i1
 double tauF_h = 0;
#define tauG_h tauG_h_KA_i1
 double tauG_h = 0.5;
#define tauDv_h tauDv_h_KA_i1
 double tauDv_h = 0;
#define tauA_h tauA_h_KA_i1
 double tauA_h = 40;
#define tau0_n tau0_n_KA_i1
 double tau0_n = 0.01;
#define tauF_n tauF_n_KA_i1
 double tauF_n = 0;
#define tauG_n tauG_n_KA_i1
 double tauG_n = 0.5;
#define tauDv_n tauDv_n_KA_i1
 double tauDv_n = 0;
#define tauA_n tauA_n_KA_i1
 double tauA_n = 20;
#define tau_h tau_h_KA_i1
 double tau_h = 0;
#define tau_n tau_n_KA_i1
 double tau_n = 0;
#define vhalfD_h vhalfD_h_KA_i1
 double vhalfD_h = -67;
#define v5_adj v5_adj_KA_i1
 double v5_adj = 0;
#define vhalfA_n vhalfA_n_KA_i1
 double vhalfA_n = 0;
#define vhalf_n vhalf_n_KA_i1
 double vhalf_n = 11;
 ...
 "gates_n_KA_i1", &gates_n_KA_i1,
 "vhalf_n_KA_i1", &vhalf_n_KA_i1,
 "slope_n_KA_i1", &slope_n_KA_i1,
 "needAdj_KA_i1", &needAdj_KA_i1,
 "vhalfA_n_KA_i1", &vhalfA_n_KA_i1,
 "slopeA_n_KA_i1", &slopeA_n_KA_i1,
 "v5_adj_KA_i1", &v5_adj_KA_i1,
 "slp_adj_KA_i1", &slp_adj_KA_i1,
 "tauA_n_KA_i1", &tauA_n_KA_i1,
 "tauDv_n_KA_i1", &tauDv_n_KA_i1,
 "tauG_n_KA_i1", &tauG_n_KA_i1,
 "tauF_n_KA_i1", &tauF_n_KA_i1,
 "tau0_n_KA_i1", &tau0_n_KA_i1,
 "gates_h_KA_i1", &gates_h_KA_i1,
 "vhalfD_h_KA_i1", &vhalfD_h_KA_i1,
 "slope_h_KA_i1", &slope_h_KA_i1,
 "tauA_h_KA_i1", &tauA_h_KA_i1,
 "tauDv_h_KA_i1", &tauDv_h_KA_i1,
 "tauG_h_KA_i1", &tauG_h_KA_i1,
 "tauF_h_KA_i1", &tauF_h_KA_i1,
 "tau0_h_KA_i1", &tau0_h_KA_i1,
 "inf_n_KA_i1", &inf_n_KA_i1,
 "tau_n_KA_i1", &tau_n_KA_i1,
 "inf_h_KA_i1", &inf_h_KA_i1,
 "tau_h_KA_i1", &tau_h_KA_i1,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 KA_i1 /home/ximing/Documents/lab_stuff/pDE_cell/i686/KA_i1.mod\n");
