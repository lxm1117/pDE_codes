...
extern int nrn_get_mechtype();
 ...
 "Boltz_m1_Naf_i1", _hoc_Boltz_m1,
 "BorgMod_tau_Naf_i1", _hoc_BorgMod_tau,
 "Boltzmann_Naf_i1", _hoc_Boltzmann,
 "ngate_adjust_Naf_i1", _hoc_ngate_adjust,
 "rates_Naf_i1", _hoc_rates,
 0, 0
};
#define Boltz_m1 Boltz_m1_Naf_i1
...
#define gates_n gates_n_Naf_i1
 double gates_n = 1;
#define inf_s inf_s_Naf_i1
 double inf_s = 0;
#define inf_h inf_h_Naf_i1
 double inf_h = 0;
#define inf_n inf_n_Naf_i1
 double inf_n = 0;
#define needAdj needAdj_Naf_i1
 double needAdj = 1;
#define slope_s slope_s_Naf_i1
 double slope_s = 8;
#define slope_h slope_h_Naf_i1
 double slope_h = 8;
#define slp_adj slp_adj_Naf_i1
 double slp_adj = 0;
#define slopeA_n slopeA_n_Naf_i1
 double slopeA_n = 0;
#define slope_n slope_n_Naf_i1
 double slope_n = -7;
#define tau0_s tau0_s_Naf_i1
 double tau0_s = 0.01;
#define tauF_s tauF_s_Naf_i1
 double tauF_s = 0;
#define tauG_s tauG_s_Naf_i1
 double tauG_s = 0.5;
#define tauDv_s tauDv_s_Naf_i1
 double tauDv_s = 0;
#define tauA_s tauA_s_Naf_i1
 double tauA_s = 2000;
...
#define tauA_n tauA_n_Naf_i1
 double tauA_n = 0.5;
#define tau_s tau_s_Naf_i1
 double tau_s = 0;
#define tau_h tau_h_Naf_i1
 double tau_h = 0;
#define tau_n tau_n_Naf_i1
 double tau_n = 0;
#define vhalfD_s vhalfD_s_Naf_i1
 double vhalfD_s = -40;
#define vhalfD_h vhalfD_h_Naf_i1
 double vhalfD_h = -40;
#define v5_adj v5_adj_Naf_i1
 double v5_adj = 0;
#define vhalfA_n vhalfA_n_Naf_i1
 double vhalfA_n = 0;
#define vhalf_n vhalf_n_Naf_i1
 ...
 "needAdj_Naf_i1", &needAdj_Naf_i1,
 "vhalfA_n_Naf_i1", &vhalfA_n_Naf_i1,
 "slopeA_n_Naf_i1", &slopeA_n_Naf_i1,
 "v5_adj_Naf_i1", &v5_adj_Naf_i1,
 "slp_adj_Naf_i1", &slp_adj_Naf_i1,
 ...
 "vhalfD_h_Naf_i1", &vhalfD_h_Naf_i1,
 ...
 "vhalfD_s_Naf_i1", &vhalfD_s_Naf_i1,
 "slope_s_Naf_i1", &slope_s_Naf_i1,
 "tauA_s_Naf_i1", &tauA_s_Naf_i1,
 "tauDv_s_Naf_i1", &tauDv_s_Naf_i1,
 "tauG_s_Naf_i1", &tauG_s_Naf_i1,
 "tauF_s_Naf_i1", &tauF_s_Naf_i1,
 "tau0_s_Naf_i1", &tau0_s_Naf_i1,
 "inf_n_Naf_i1", &inf_n_Naf_i1,
 "tau_n_Naf_i1", &tau_n_Naf_i1,
 "inf_h_Naf_i1", &inf_h_Naf_i1,
 "tau_h_Naf_i1", &tau_h_Naf_i1,
 "inf_s_Naf_i1", &inf_s_Naf_i1,
 "tau_s_Naf_i1", &tau_s_Naf_i1,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Naf_i1 /home/ximing/Documents/lab_stuff/pDE_cell/i686/Naf_i1.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 83 in file Naf_i1.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
