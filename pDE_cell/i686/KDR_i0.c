...
extern int nrn_get_mechtype();
 ...
 "setdata_KDR_i0", _hoc_setdata,
 "BorgMod_tau_KDR_i0", _hoc_BorgMod_tau,
 "Boltzmann_KDR_i0", _hoc_Boltzmann,
 "rates_KDR_i0", _hoc_rates,
 0, 0
};
#define BorgMod_tau BorgMod_tau_KDR_i0
#define Boltzmann Boltzmann_KDR_i0
 extern double BorgMod_tau();
 extern double Boltzmann();
 /* declare global and static user variables */
#define gates_n gates_n_KDR_i0
 double gates_n = 1;
#define inf_n inf_n_KDR_i0
 double inf_n = 0;
#define slope_n slope_n_KDR_i0
 double slope_n = -10;
#define tau0_n tau0_n_KDR_i0
 double tau0_n = 0.8;
#define tauF_n tauF_n_KDR_i0
 double tauF_n = 0;
#define tauG_n tauG_n_KDR_i0
 double tauG_n = 0.8;
#define tauDv_n tauDv_n_KDR_i0
 double tauDv_n = 0;
#define tauA_n tauA_n_KDR_i0
 double tauA_n = 5.9;
#define tau_n tau_n_KDR_i0
 double tau_n = 0;
#define vhalf_n vhalf_n_KDR_i0
 double vhalf_n = -5;
 ...
 "gates_n_KDR_i0", &gates_n_KDR_i0,
 "vhalf_n_KDR_i0", &vhalf_n_KDR_i0,
 "slope_n_KDR_i0", &slope_n_KDR_i0,
 "tauA_n_KDR_i0", &tauA_n_KDR_i0,
 "tauDv_n_KDR_i0", &tauDv_n_KDR_i0,
 "tauG_n_KDR_i0", &tauG_n_KDR_i0,
 "tauF_n_KDR_i0", &tauF_n_KDR_i0,
 "tau0_n_KDR_i0", &tau0_n_KDR_i0,
 "inf_n_KDR_i0", &inf_n_KDR_i0,
 "tau_n_KDR_i0", &tau_n_KDR_i0,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 KDR_i0 /home/ximing/Documents/lab_stuff/pDE_cell/i686/KDR_i0.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 44 in file KDR_i0.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
